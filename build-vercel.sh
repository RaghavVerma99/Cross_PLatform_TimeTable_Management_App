...
# 1. Clone Flutter stable branch with depth 1 to minimize download size and build time
if [ ! -d "flutter" ]; then
...
# 5. Automatically generate the web/ subdirectory (and other platform folders) 
# so we don't need to commit heavy platform boilerplates to our git repository
